...
export default function CardImage({
  ...
  return (
    <div className="bg-white dark:divide-gray-700 border-gray-aa border-red-300 mb-4 flex flex-col justify-between rounded-sm border border-solid shadow hover:shadow-xl sm:p-6">
      <div className="flex flex-col p-4 sm:flex-row">
        <img
          src={imgSrc?.replace("{value}", "q_auto,c_thumb,w_300")}
          alt="Your Image"
